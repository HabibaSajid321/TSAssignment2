...
let celcius:number = 12;
let farenheit:number = celcius*1.8+32;
...
let originalPrice:number = 1000;
let discountonGreaterthan100:number = originalPrice*0.1;
let discountonlessthan100:number = originalPrice*0.5;

 let newPricefor10percent:number = originalPrice - discountonGreaterthan100;
 let newPricefor5percent:number = originalPrice - discountonlessthan100;
